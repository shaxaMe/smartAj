<template>
    <div class="cm-container py-10  max-lg:px-5 max-md:py-5">
        ...
        <div class="mt-5 flex flex-col gap-20 max-md:gap-8">
            <h1 data-aos="fade-up" data-aos-duration="700" data-aos-offest="400" class="text-[#101011] text-5xl font-semibold leading-[110%] max-md:text-2xl max-sm:text-2xl max-sm:text-center">Globally Recruitment and <br>
                Consultation Solutions</h1>
            <div class="flex gap-4 justify-between max-md:flex-wrap">
                <div class="bg-[#F6F6F7] p-10 text-black max-w-[300px] max-md:max-w-full max-sm:min-h-[200px] max-md:flex-1 rounded-xl" data-aos="fade-left" data-aos-duration="700" data-aos-offest="100">
                    ...
                    <p class="font-semibold text-2xl my-4 max-sm:text-xl max-sm:my-2">Strategy
                        Development</p>
                ...
                <div class="bg-[#F6F6F7] max-md:flex-1 p-10 text-black max-md:max-w-full max-w-[300px] rounded-xl" data-aos="fade-left" data-aos-duration="1200" data-aos-offest="100">
                    ...
                    <p class="font-semibold text-2xl my-4">Strategy
                        Development</p>
                    <p class="text-[#101011] text-lg">
                        Crafting long-term goals
                        and competitive strategies.
