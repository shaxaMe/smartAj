<template>
    <div class="cm-container max-md:px-5 py-3" :class="{'!fixed top-0 !max-w-[100%] left-0 w-full bg-white':windowScrollY>120}" data-aos="fade-down" data-aos-duration="550">
        <div class="w-full min-h-[60px] flex justify-between items-center" :class="{'max-w-[1330px] mx-auto':windowScrollY>120}">
            ...
            <nav
                ...
                <a href="#about" class="nav-link app-nav relative">{{ t('about') }}</a>
                ...
                <a href="#products" class="nav-link app-nav relative">{{ t('products') }}</a>
                <a href="#news" class="nav-link app-nav relative">{{ t('news') }}</a>
                <a href="#vacancy" class="nav-link app-nav relative">{{ t('vacansy') }}</a>
