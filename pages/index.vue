        ...
        <section class="bg-[#F2F5F7] py-10 max-md:py-5">
            <div class="cm-container flex max-md:gap-4 max-md:px-5 max-md:flex-col">
                <div class="flex-1 mt-20 max-md:mt-5 flex flex-col justify-between">
                        ...
                        <div class="text-black text-6xl max-md:text-5xl max-sm:text-3xl max-md:text-center w-full font-semibold leading-[110%] max-md:leading-[120%] max-[350px]:text-2xl">
                            ...
                            <div class="flex gap-4 max-md:text-center max-md:justify-center max-sm:gap-2">
                                ...
                                <p class="w-fit relative flex flex-col">
                                    ...
                                    <NuxtImg src="https://raw.githubusercontent.com/shaxaMe/cfgcs/c7ba119359f7c2674f6cad75d53c71fb89522ac1/line.svg" class="h-auto absolute w-full top-4 max-sm:top-2" />
                                </p>
                            </div>
                        </div>
                        <p class="text-[#404144] text-[1.5em] max-sm:text-[1em] leading-[130%] max-md:text-center">Discover our app for seamless rewards
                            -
                            access<br>
                            perks, cashbacks, and savings effortlessly.</p>
                        <div class="flex justify-start max-md:justify-center max-sm:flex-col max-md:w-full items-stretch gap-3">
                            <UInput class="ui-input max-sm:max-w-full target-button max-w-[250px] flex-1" icon="i-material-symbols:mail" size="xl"
                    ...
                    <div class="flex justify-start max-md:justify-center items-stretch text-[#101011] mt-7" data-aos="fade-right" data-aos-easing="ease-in-back" data-aos-duration="750">
                        <div class="w-fit pr-8 max-md:pr-3 py-2">
                            <p class="text-4xl max-md:text-center max-md:text-3xl max-sm:text-2xl font-semibold">30M</p>
                        ...
                        <div class="w-fit pl-8 max-md:pl-3 py-2">
                            <p class="text-4xl max-md:text-center max-md:text-3xl max-sm:text-2xl font-semibold">250</p>
                            <p class="text-base max-sm:text-sm max-sm:text-center max-sm:mt-1">Paid in cashbacks</p>
                        </div>
                    </div>
                </div>
                <div class="flex-1 max-md:flex max-md:justify-center" data-aos="fade-left" data-aos-duration="650" data-aos-easing="ease-in-back">
                    <NuxtImg src="https://raw.githubusercontent.com/shaxaMe/cfgcs/c7ba119359f7c2674f6cad75d53c71fb89522ac1/main.svg" class="w-full max-w-[650px] max-md:max-w-[450px] max-h-[600px]" />
                </div>
            </div>
        </section>
        <section>
